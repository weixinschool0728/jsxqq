function replaceReg(str){ 
		...
		str = str.replace(re,"<iframe height=400 width=100% src=\"http://player.youku.com/embed/$1\" frameborder=0 allowfullscreen></iframe>"); 
		var re = /http:\/\/v.youku.com\/v_show\/id_(\S+)\.html/gim; 
		str = str.replace(re,"<iframe height=400 width=100% src=\"http://player.youku.com/embed/$1\" frameborder=0 allowfullscreen></iframe>"); 
		var reg = /http:\/\/player.video.qiyi.com\S+tvId=\d+/ig; 
		str = str.replace(reg,function(m){return '<embed height=400 width=100% src="'+m+'" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" wmode="opaque" ></embed>';}) ;
		...
		str = str.replace(re,"<iframe height=400 width=100% src=\"http://v.qq.com/iframe/player.html?vid=$1&tiny=0\" frameborder=0 allowfullscreen></iframe>");
var re = /http:\/\/static.video.qq.com\/TPout.swf\?auto=\d&(\S{0,})vid=(\S+) /gim; 
		str = str.replace(re,"<iframe height=400 width=100% src=\"http://v.qq.com/iframe/player.html?vid=$2&tiny=0\" frameborder=0 allowfullscreen></iframe>"); 
		return str;
	} 
