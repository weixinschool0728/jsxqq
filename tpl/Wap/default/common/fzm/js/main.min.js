...
!function() {
    ...
    var a = $("#box"), b = "span", c = $("#help p"), d = $("#help_color"), e = {lvT: ["龙叔的脑残粉", "龙叔的忠实粉", "龙叔的路人粉", "慧眼识祖名", "火眼金睛", "洞察一切", "两眼冒光", "24k氪金眼", "已被亮瞎！"],render: function(e, f) {
            ...
            a.find(b).css("background-color", i[1]).data("type", "b").css({"background": "url(http://mat1.gtimg.com/ln/images/2014zt/08/1819/109451991.png)"+j[1], "background-size": "cover"}), a.find(b).eq(h).css("background-color", j[1]).data("type", "a").css({"background": "url(http://mat1.gtimg.com/ln/images/2014zt/08/1819/109451988aa.png)"+j[1], "background-size": "cover"});
        },getColor: function(a) {
