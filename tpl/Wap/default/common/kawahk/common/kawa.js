...
function zk_build_card()
{
    ...
    {
        url = '/index.php?g=Wap&m=Kawahk&a=hcar_view&token={weimicms:$token}&id={weimicms:$id}&cardid={weimicms:$cardid}&cardid=' + kawa_data.cardid;
...
function on_modifymusic_click()
{
    ...
    var url="http://demo.wfccms.com/index.php?g=Wap&m=Kawahk&a=mp3";
    url=url+"&cardid=" + kawa_data.cardid;
    url=url+"&optfile=" + kawa_data.modify_optfile;
    if(kawa_data.modify_optwords != '#modify_optwords#')
    {
