    ...
    function(e, t) {
        ...
        function h() {
            ...
            if (!e) {
                ...
                e.innerHTML = Ht.channelLogo ? [Ht.channelAloneLogo ? '<div class="inner alone"><img src="' + ht + "/images/home/loading_" + lt + '.png"></div>' : "", '<div class="inner"' + (6 > o || o > 20 ? ' style="background: #2c2a2a;"' : "") + ">", '<img src="' + ht + '/images/home/logo_wr_220x100_black.png" height="80">', '<img src="' + ht + "/images/home/logo_" + lt + '.png" height="80">', t ? "<p>" + (pt[lt][3] ? "“<strong>" + pt[lt][0] + "</strong>”" : "<strong>微米</strong> &bull; <strong>" + t + "</strong>") + " 原创出品</p><p>授权" + (pt[lt][3] ? "<strong>微米</strong>" : "“<strong>" + pt[lt][0] + "</strong>”") + (pt[lt][5] || "联合发布") + "</p><p>转载请经过授权，侵权必究</p>" : "<p>" + (pt[lt][3] ? "“<strong>" + pt[lt][0] + "</strong>”出品, 授权<strong>微米</strong>" + (pt[lt][5] || "联合发布") : "<strong>微米</strong>出品, 授权“<strong>" + pt[lt][0] + "</strong>”" + (pt[lt][5] || "联合发布")) + "</p>", '<p class="hw_info">游戏载入中...</p>', '<div class="progress" style="display:none;"><div class="bar">0%</div></div>', "</div>"].join("") : ['<div class="inner"' + (6 > o || o > 20 ? ' style="background: #2c2a2a;"' : "") + ">", '<img src="' + ht + '/images/home/logo_wr_220x100_black.png" height="80">', t ? "<p><strong>微米游戏</strong> &bull; <strong>" + t + "</strong> 原创出品</p><p>转载请经过授权，侵权必究</p>" : "<p>微米游戏 &bull; 为未来而生</p>", '<p class="hw_info">游戏载入中...</p>', '<div class="progress" style="display:none;"><div class="bar">0%</div></div>', "</div>"].join(""), e.addEventListener(nt, R), e.addEventListener(it, R), A("body").appendChild(e)
            }
            return e
        }
        function g(e) {
        ...
        Ot.ready(function() {
            ...
            var b = Ht.share,
                w = {
                    ...
                    link: bt,
                    query: "",
                    title: b.title || Z.title || "微米游戏",
                    desc: b.desc || Z.title || "微米游戏"
                };
