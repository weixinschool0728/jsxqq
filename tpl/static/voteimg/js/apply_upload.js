    ...
    init: function() {
        ...
        function() {
            ...
            if (file.size > maxSize) {
                err = "图片超过"+(maxSize/1024/1024)+"M尺寸限制！"
...
//		loadingStr ='<li class="upload_action"><img src="{weimicms:$staticPath}/tpl/static/voteimg/img/upimg.png" width="100px"><input type="file" accept="image/jpg,image/jpeg,image/png,image/gif" id="fileImage" name="filename" id="baodinpu">';	//上传状态不让提交
