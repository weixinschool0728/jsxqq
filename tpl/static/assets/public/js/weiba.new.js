...
$(function () {
    if (!$('.weiba-js').length > 0) {
        var src = '<script type="text/javascript" class="weiba-js" src="/tpl/static/assets/public/js/weiba.js" charset="utf-8"></script>';
        $('script[src*="/tpl/static/assets/public/js/weiba.new.js"]').before(src);
...
(function (window, $) {
    ...
    $.getUID = function () {
        if (!$('.weiba-account-js').length > 0) {
            var src = '<script type="text/javascript" class="weiba-account-js" src="/tpl/static/assets/public/js/weiba.account.js" charset="utf-8"></script>';
            $('script[src*="/tpl/static/assets/public/js/weiba.new.js"]').before(src);
    ...
    $.checkUID = function (tips) {
        var tip = tips ? tips : "请点击右上角菜单->查看公众号,关注后回复:"+keyword;
        var uid = $.getWXID();
        if (!uid) {
            alert(tip);
