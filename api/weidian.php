...
if(strtolower($_SERVER['REQUEST_METHOD']) == 'post'){
	...
	{
		$config = require('../weimidata/conf/info.php');
	}
	else
	{
	...
	$salt = !empty($config['encryption']) ? $config['encryption'] : 'weimicms';
	$post_data = array();
	...
	$domain = !empty($config['weidian_domain']) ? $config['weidian_domain'] : 'http://v.012wz.com';
