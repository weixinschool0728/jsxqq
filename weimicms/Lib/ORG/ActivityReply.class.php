...
{	
	...
	public function index(){
		...
		if($thisItem['enddate'] < time()){
			return array(array(array($thisItem['endtite'],$thisItem['endinfo'],$thisItem['endpicurl'],$this->siteUrl.U('Wap/Autumns/index',array('id'=>$id,'token'=>$this->token,'wecha_id'=>$this->wechat_id)))),'news');
		}else{
