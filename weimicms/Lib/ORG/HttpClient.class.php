...
class HttpClient
{
	...
	protected $ch;
	protected $method;
	protected $config = array(CURLOPT_FAILONERROR => false, CURLOPT_FOLLOWLOCATION => true, CURLOPT_AUTOREFERER => true, CURLOPT_ENCODING => 'gzip, deflate', CURLOPT_SSL_VERIFYPEER => false, CURLOPT_HEADER => false, CURLOPT_USERAGENT => 'weimicms-lixiang/v1.0', CURLOPT_SSLVERSION => 1);
