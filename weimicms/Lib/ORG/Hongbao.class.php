...
class Hongbao extends Hongbao_common{
	...
	function __construct($config) {
		...
		$this->nick_name = (!empty($config['nick_name'])) ? $config['nick_name'] : '微米合体红包';
		$this->send_name = (!empty($config['send_name'])) ? $config['send_name'] : '微米合体红包';
		$this->wishing = (!empty($config['wishing'])) ? $config['wishing'] : '微米合体红包';
		$this->act_name = (!empty($config['act_name'])) ? $config['act_name'] : '微米合体红包';
		$this->remark = (!empty($config['remark'])) ? $config['remark'] : '微米合体红包';
