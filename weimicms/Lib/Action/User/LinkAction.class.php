...
class LinkAction extends UserAction{
	...
	public function _initialize() {
		...
		$this->arr=array('game','Knwx','Jingcai','Jiugong','Fanyan','Invite','Hforward','Lapiao','Jikedati','Sharetalent','Red_packet','Autumns','Popularity','Helping','MicroBroker','Seckill','Unitary','Crowdfunding','DishOut','LivingCircle','Test','Bargain','Service','Hongbao','Micrstore','SeniorScene','SeniorCard','ServiceChat','Voteimg','Cutprice','Person_card','Numqueue','Punish');
	}
