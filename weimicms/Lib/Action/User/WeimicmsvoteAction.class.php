<?php
class WeimicmsvoteAction extends UserAction{
    ...
    public function del_record(){
        ...
        if(M('Mbvote_record')->where(array('id'=>$id))->delete()){
            ...
            $this->success('删除成功',U('Weimicmsvote/index',array('token'=>session('token'))));
        }
           ...
           // }
            ...
            if($data->create()!=false){
                if($id=$data->add()){
                    ...
                    $this->success('添加成功',U('Weimicmsvote/index',array('token'=>session('token'))));
                }else{
        ...
        if(IS_POST){
            ...
            if($data->create()){
                ...
                if($data->where($where)->save($_POST)){
                    ...
                    $this->success('修改成功!',U('Weimicmsvote/index',array('token'=>session('token'))));exit;
                }else{
