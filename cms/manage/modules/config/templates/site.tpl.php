...
<div class="columntitle">网站配置</div>
   <form method="post" action="?m=config&c=config&a=site" id="myform">
     <table class="addTable">
      <tr>
          <th>名称</th>
          <td><input type="text" name="info[name]" id="name" size="20" class="validate['required'] colorblur" onfocus="this.removeClass('colorblur');this.addClass('colorfocus');" onblur="this.removeClass('colorfocus');this.addClass('colorblur');" value="<?php echo $thisSite['name'];?>"> <span class="tdtip"></span></td>
        </tr>
       <tr>
          <th>logo</th>
