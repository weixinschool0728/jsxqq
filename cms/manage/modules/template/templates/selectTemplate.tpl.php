...
<li class="active">
	...
	<div class="text" style="height:30px;"><input class="radio" type="radio" name="templateIndex" value="<?php echo $t['templateindex'];?>"<?php if ((!$this->site['template']&&$i==0)||($this->site['template']&&$t['templateindex']==$this->site['template'])){echo ' checked';} ?> /> <?php echo $t['name'];?> <a href="?m=template&c=m_template&a=templatePreview&skin=<?php echo $t['templateindex'];?>" target="_blank">预览</a></div>
	</label>
</li>
 <?php
 $i++;
