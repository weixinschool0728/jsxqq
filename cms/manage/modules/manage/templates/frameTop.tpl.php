...
<title>无标题文档</title>
<?php
$dbConfigFile=$_SERVER['DOCUMENT_ROOT'].'/weimidata/conf/info.php';
...
if (!$sitelogo){
	$sitelogo='/tpl/Home/weimicms/common/images/logo-weimicms.png';
}
?>
</head>
<body>
...
?>
|<a href="<?php echo '../index.php?token='.$this->token;?>" target="_blank">访问网站</a>|<a href="<?php echo weimicms_URL.'/index.php?g=User&m=Home&a=set&token='.$this->token;?>" target=_top style="color:#99C9EA">返回管理中心</a>
</div>
</div>
</td>
  </tr>
